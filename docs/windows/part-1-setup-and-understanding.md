# Part 1: Understanding MCP & Workshop Setup (Windows)

> **Workshop Navigation**: [Part 2: Local Development →](part-2-local-development.md) | **Platform**: 🪟 Windows/PowerShell
...
- **PowerShell 5.1+**: For running workshop scripts
...
# Edit local.settings.json to contain:
@"
{
  "IsEncrypted": false,
  "Values": {
...
This workshop includes comprehensive PowerShell test scripts:
...
.\test-workshop.ps1 -TestLevel azure -FunctionUrl "https://your-app.azurewebsites.net"
...
Your Windows development environment is configured and ready to build the MCP server.
...
> **Next Step**: Continue to [Part 2: Local Development →](part-2-local-development.md) where we'll build and test the MCP server locally with all three custom tools using PowerShell commands.
...
- [PowerShell Azure Functions Development](https://docs.microsoft.com/en-us/azure/azure-functions/functions-reference-powershell)